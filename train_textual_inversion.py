...
class TextualInversionTrainer:
    ...
    def train(self, args):
        ...
        noise_scheduler = DDPMScheduler(
            prediction_type="epsilon", variance_type="learned", beta_start=0.00085, beta_end=0.012, beta_schedule="squaredcos_cap_v2", num_train_timesteps=1000, clip_sample=False, rescale_betas_zero_snr=args.zero_terminal_snr
        )
