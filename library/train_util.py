...
def add_training_arguments(parser: argparse.ArgumentParser, support_dreambooth: bool):
    ...
    parser.add_argument(
        ...
        type=float,
        default=0,
        help="The percentage of the training which we start to aply the noise",
    )
    parser.add_argument(
        "--ip_noise_end",
        type=float,
...
def get_my_scheduler(
    *,
    ...
    elif sample_sampler == "dpmsolver" or sample_sampler == "dpmsolver++" or sample_sampler == 'k-dpmsolver++' or sample_sampler == "sde-dpmsolver++" or sample_sampler == "k-sde-dpmsolver++" or sample_sampler == 'lu-sde-dpmsolver++':
